...
#TODO this file is evolving from copy of question_sdc_landmark.
# still far from ready.


class question_on_topN(question_seq):
...
#            print "NO FIGURE"
        ...
        if sdc["sr"]==None:
            qn.qn_text = qn.qn_text.replace("<SR>","by")
        else:
        ...
        if sdc["landmark"]==None:
            ...
            qn.qn_text = qn.qn_text.replace("<LANDMARK>","the "+str(sdc["landmark"]))
        ...
        modified_sdc["landmarks"].append(lmrk)
        yes_actn = {"action":"modify","position":pos,"sdc":modified_sdc}
